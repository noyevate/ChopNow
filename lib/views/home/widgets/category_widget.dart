    ...
    return GestureDetector(
      ...
      child: Obx(() => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: controller.categoryValue == category['_id'] ? Tcolor.primary : Tcolor.white, width: 1.5.w),
        ),
        child: Column(
          children: [
            ...
            ReuseableText(title: category['name'], style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Tcolor.Text))
          ],
        ),
      ),
      )
